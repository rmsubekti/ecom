...
if (empty($_SESSION['namauser']) and empty($_SESSION['iduser'])){
    echo "<script>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                <?php echo $_SESSION['namauser']?> - Web Developer
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php if ($_GET['module']=='merek') echo 'active'; ?>">
          <a href="adminweb.php?module=merek">
            <i class="fa fa-eye"></i> <span>Merek</span>
          </a>
        </li>
        <li class="<?php if ($_GET['module']=='produk') echo 'active'; ?>">
          <a href="adminweb.php?module=produk">
            <i class="fa fa-th"></i>
            <span>Produk</span>
          </a>
        </li>
        <li class="<?php if ($_GET['module']=='biaya_kirim') echo 'active'; ?>">
          <a href="adminweb.php?module=biaya_kirim">
            <i class="fa fa-car"></i>
            <span>Biaya Kirim</span>
          </a>
        </li>
        <li class="<?php if ($_GET['module']=='pesanan') echo 'active'; ?>">
          <a href="adminweb.php?module=pesanan">
            <i class="fa fa-money"></i> <span>Pesanan</span>
          </a>
        </li>
        <li class="<?php if ($_GET['module']=='penjualan') echo 'active'; ?>">
          <a href="adminweb.php?module=penjualan">
            <i class="fa fa-bar-chart"></i> <span>Penjualan</span>
          </a>
        </li>
        <li class="<?php if ($_GET['module']=='member') echo 'active'; ?>">
          <a href="adminweb.php?module=member">
            <i class="fa fa-users"></i> <span>Member</span>
          </a>
        </li>
        <li class="<?php if ($_GET['module']=='admin') echo 'active'; ?>">
...
if ($_GET['module']=='biaya_kirim') {
    include 'module/biaya-kirim/list_biaya_kirim.php';
}else if ($_GET['module']=='tambah_biaya_kirim') {
    include 'module/biaya-kirim/form_tambah.php';
}else if ($_GET['module']=='edit_biaya_kirim') {
  include 'module/biaya-kirim/form_edit.php';
}else 
//member
