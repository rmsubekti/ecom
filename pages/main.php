				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<?php $qkategori = mysqli_query($conn, "select * from tbl_kategori");
								while($kat=mysqli_fetch_array($qkategori)){
							?>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#"><?php echo $kat['nama_kategori']?></a></h4>
								</div>
							</div>
								<?php }?>
							<!-- <div class="panel panel-default">
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								...
								<?php $qmerek = mysqli_query($conn, "select * from tbl_merek");
								while($mer=mysqli_fetch_array($qmerek)){
							?>
							<li><a href="#"> <?php echo $mer['nama_merek']?></a></li>
								<?php }?>
